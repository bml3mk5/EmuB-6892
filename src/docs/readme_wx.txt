...
「画面(Screen)」メニュー
  ...
  「描画方法(Drawing Method)」 .... 描画方法 サブメニュー
    「デフォルト描画(Default Drawing)」..........
          デフォルト描画。画面内のメッセージやインジケータがちらつきます。
    「デフォルト(ダブルバッファ)(Default (Double Buffering)」.......
          デフォルト描画。内部バッファで画面を合成してから出力。
  ...
  【注意】ソフトを再起動しないと設定が反映されない場合があります。
...
○ キー操作説明
  ...
  レベル3のキー    Mac側のキー         Linux側のキー    Windows側のキー
  ---------------- ------------------- ---------------- ---------------------
  [BREAK]          [F9]                [F9]             [F9]
  [GRAPH]          [F8] / [英数]       [F8] / [無変換]  [F8] / [無変換]
  [KATA/HIRA]      [TAB] / [右command] [TAB] / [変換]   [TAB] / [変換]
  [DEL/INS]        [delete]            [Delete] / [BS]  [Delete] / [BS]
  [CAPSLOCK]       [F7] / [CAPS]       [F7] / [CAPS]    [F7] / [Shift]+[CAPS]
  [テンキー ?]     [end]               [END]            [END]
